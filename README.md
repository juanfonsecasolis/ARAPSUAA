...
Disclaimer
---
Although no grant or scholarship was used to create ARAPSUAA, it uses the theory publicly published by the University of Costa Rica (UCR) in the paper [Automatic recognition of accessible pedestrian signals](https://doi.org/10.1121/2.0000675), presented at the Journal of the Acoustical Society of America (141-3913; Boston, USA; 2017). This paper was published as part of the project [B6146](https://vinv.ucr.ac.cr/sigpro/web/projects/B6146) that released too and Android Application called _Reconocimiento Acústico de Señales Peatonales_ (RASP). The code of the application was written in Java, is private, and belongs to the UCR; in a different way, the code of ARAPSUAA was written completely in Python and serves as a scientific library. I have made public the code of ARAPSSUAA for the sake of reproducible research, moreover, because I want to encourage researchers living in low-income-countries (LIC) to perform independent research when working full-time in the academia is not possible.
