...
Disclaimer
---
No grant, scholarship or other financial help provided by any public or private organization supported the elaboration of the code and documentation of ARAPSUAA. I have made public this resources because I believe that reproducibility provides evidence to show that real progress in science has been made. Also, because I wanted to encourage other researchers on low-income-countries (LIC) to continue doing independent research even if no funds are available to let them work full-time in the academia. 
