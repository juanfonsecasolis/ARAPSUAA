...
Disclaimer
---
The code of ARAPSUAA was written in Python to serve as a scientific library. Although no grant or scholarship was used to create ARAPSUAA, it is based on the theory publicly published by the University of Costa Rica for the project [B6146](https://vinv.ucr.ac.cr/sigpro/web/projects/B6146), whose code was written privately in Java and released in the Android application _Reconocimiento Acústico de Señales Peatonales_ (RASP). I have made public the code of ARAPSSUAA for the sake of reproducible research, moreover, because I want to encourage researchers living in low-income-countries (LIC) to perform independent research when working full-time in the academia is not possible.
