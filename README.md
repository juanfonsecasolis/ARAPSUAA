...
Disclaimer
---
Although we received no grant or scholarship to create ARAPSUAA, we took as basis the theory publicly published by the University of Costa Rica (UCR) in the paper [Automatic recognition of accessible pedestrian signals](https://doi.org/10.1121/2.0000675) (Journal of the Acoustical Society of America; 141-3913; Boston, USA; 2017). This paper was published as part of the project [B6146](https://vinv.ucr.ac.cr/sigpro/web/projects/B6146) where an Android Application called _Reconocimiento Acústico de Señales Peatonales_ (RASP) was released. The code of the application belongs to the UCR, is private, and was written in Java, in an opposite way, the code of ARAPSUAA was written completely in Python and serves as a scientific library. I have made public the code of ARAPSSUAA for the sake of reproducible research, moreover, because I want to encourage researchers living in low-income-countries (LIC) to perform independent research when working full-time in the academia is not possible.
